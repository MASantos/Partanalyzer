...
void printHelp(){
	...
	cout<<"   For analyzing partitions                                          "<<endl;
        cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] (-v|-e|-p|-i) partition1  partition2  [partition1_offset (=2) ] [partition2_offset (=partition1_offset) ] "<<endl;
	...
	cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] (-J|-R|-T) [-ext extensivity] [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] (-V|-E|-P) [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] --ipot entropy [-ext extensivity] [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] (-C|-H) [-cons] [-ofs partition_offset (=2)] [-f partition_list | [partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       "<<_programb_<<" [--verbose][-q] [-t pfmt] (-A|-S|-I) [-ofs partition_offset (=2)] [-f partition_list | [partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<endl;
	...
	cout<<"       "<<_programb_<<" [--verbose][-q] --seq-noclone-sequences fasta_sequence_file [reference_sequence_file]"<<endl;
	cout<<endl;
	...
	cout<<"       "<<_programb_<<" [--verbose][-q] --msa-drop-sequences sequences_file multiple_seq_alignment.fasta"<<endl;
