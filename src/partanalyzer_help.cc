...
void printHelpLong(){
	...
	cout<<"                                                                       "<<endl;
	cout<<"       --MSAtoPART                                                     "<<endl;
	cout<<"           converts a MSA file in FASTA format containing the          "<<endl;
	cout<<"           labeling of clusters into a partition in PART format. Cluster"<<endl;
	cout<<"           labels are expected in a separate line before the actual    "<<endl;
	cout<<"           set of sequences, i.e.,                                     "<<endl;
	cout<<"           %Group_A                                                    "<<endl;
	cout<<"           >Sequence_A1                                                "<<endl;
	cout<<"           ...                                                         "<<endl;
	cout<<"           or                                                          "<<endl;
	cout<<"           ==Group_A                                                   "<<endl;
	cout<<"           >Sequence_A1                                                "<<endl;
	cout<<"           ...                                                         "<<endl;
	cout<<"           Escape characters indicating cluster labels can be mixed in "<<endl;
	cout<<"           the same file, although it's not recommended.               "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"For dealing with (fasta) sequence files                                "<<endl;
