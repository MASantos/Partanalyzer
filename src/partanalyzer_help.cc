...
void printHelp(){
	...
	cout<<"        COMMANDS                               "<<endl;
	cout<<endl;
	cout<<"   Defining the algebra of partitions                                "<<endl;
        cout<<"       (-i|-u) partition1  partition2  [partition1_offset (=2) ] [partition2_offset (=partition1_offset) ] "<<endl;
	cout<<"       (-I|-U) [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<endl;
	cout<<"   For analyzing partitions                                          "<<endl;
        cout<<"       (-v|-e|-p) partition1  partition2  [partition1_offset (=2) ] [partition2_offset (=partition1_offset) ] "<<endl;
	...
	cout<<"       (-Q|-R|-T) [-ext extensivity] [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	...
	cout<<"       (--mpot|--cmpot|--SSSA) entropy [-ext extensivity] [-ofs partition_offset (=2)] [-f partition_list | partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       (-C|-H) [-cons] [-ofs partition_offset (=2)] [-f partition_list | [partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<"       (-A|-S|--Info) [-ofs partition_offset (=2)] [-f partition_list | [partition1 [ partition2 [ ... ]]]"<<endl;
	cout<<endl;
...
void printHelpLong(){
	...
	cout<<"                                                                       "<<endl;
	cout<<" COMMANDS:                                                             "<<endl;
	cout<<"Defining algebra of partitions                                         "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       -i , --intersection , -m , --meet                               "<<endl;
	cout<<"          Calculate the intersection of  partition1 & partition2       "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       -u , --union , -j , --join                                      "<<endl;
	cout<<"          Calculate the union of  partition1 & partition2. This can be "<<endl;
	cout<<"          seen as the algebraic optimal consensus partition covering   "<<endl;
	cout<<"          partition1 and partition2. Optimal means the most refined    "<<endl;
	cout<<"          partition that covers both.                                  "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       -I , --Intersection , -M , --Meet                               "<<endl;
	cout<<"          Calculate the intersection of  all partitions provided       "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       -U , --Union , -J , --Join                                      "<<endl;
	cout<<"          Calculate the union of all partitions provided. This can be  "<<endl;
	cout<<"          seen as the algebraic optimal consensus partition covering   "<<endl;
	cout<<"          each and every input partition. Here, optimal means the most "<<endl;
	cout<<"          refined partition that covers any of the input partitions.   "<<endl;
	cout<<"          Remark: This algebraic consensus is very sensitive to outlier"<<endl;
	...
	cout<<"                                                                       "<<endl;
	cout<<"       -Q , --qstat [-ext extensivity] [-ref]                          "<<endl;
	...
	cout<<"                                                                       "<<endl;
	cout<<"       -n , --ipot  entropy [(-e|-ext) extensivity] [-ref]             "<<endl;
	cout<<"          Calculates (information theoretic) potential (entropy) of each"<<endl;
	cout<<"          partition. The possible values for entropy are (short|long): "<<endl;
	cout<<"          v | s | vonneumann | shannon                                 "<<endl;
	cout<<"          b     | boltzmann                                            "<<endl;
	cout<<"          c | e | cardinality                                          "<<endl;
	cout<<"          r     | renyi                                                "<<endl;
	cout<<"          t     | tsallis                                              "<<endl;
	cout<<"          q     | tarantola/jeffrey/tjqn                               "<<endl;
	cout<<"          Both, long and short option names are valid.                 "<<endl;
	cout<<"          Default extensivity coefficient is "<<EXTENSIVITY_DEFAULT_RENYI<<"."<<endl;
	cout<<"          For cardinality potential, this coefficient will be used as a"<<endl;
	cout<<"          gauge determining the card(1)=1+extensivity.                 "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --cpot, --conditional-potential entropy [-ext extensivity] [-ref]"<<endl;
	cout<<"          Calculates conditional entropy for each pair of partitions.  "<<endl;
	cout<<"          The possible values for entropy and extensivity are the same "<<endl;
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --jpot, --joint-potential entropy [-ext extensivity] [-ref]     "<<endl;
	cout<<"          Calculates joint entropy for each pair of partitions.        "<<endl;
	cout<<"          The possible values for entropy and extensivity are the same "<<endl;
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --mpot, --mutual-potential entropy [-ext extensivity] [-ref]    "<<endl;
	cout<<"       --SA, --subadditivity entropy [-ext extensivity]                "<<endl;
	cout<<"          Calculates the mutual potential (mutual information)         "<<endl;
	cout<<"          for each pair of partitions. If positive, subadditivity holds."<<endl;
	cout<<"          The possible values for entropy and extensivity are the same "<<endl;
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --cmpot, --conditional-mutual-potential entropy [-ext extensivity]"<<endl;
	cout<<"       --SSA, --strong-subadditivity entropy [-ext extensivity] [-ref] "<<endl;
	cout<<"          Calculates the conditional mutual potential (conditional     "<<endl;
	cout<<"          mutual information) for each pair of partitions. If positive,"<<endl;
	cout<<"          for all three partitions, then strong subadditivity holds.   "<<endl;
	cout<<"          The possible values for entropy and extensivity are the same "<<endl;
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --SSSA, --soft-strong-subadditivity entropy [-ext extensivity] [-ref]"<<endl;
	cout<<"          Calculates a softer version of the strong subadditivity      "<<endl;
	cout<<"          condition for all three partitions. If positive, then the    "<<endl;
	cout<<"          potential acts as a norm and defines a metric, which thus    "<<endl;
	cout<<"          satisfies the triangular inequality.                         "<<endl;
	cout<<"          The possible values for entropy and extensivity are the same "<<endl;
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --v-measure-h , --v-measure-harmonic entropy [-ext extensivity] [-ref]"<<endl;
	...
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --v-measure-a , --v-measure-arithmetic entropy [-ext extensivity] [-ref]"<<endl;
	cout<<"          Analogous to --v-measure-h but using arithmetic mean between "<<endl;
	cout<<"          homogeneity and completeness.                                "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --v-measure-g , --v-measure-geometric entropy [-ext extensivity] [-ref]"<<endl;
	...
	cout<<"                                                                       "<<endl;
	cout<<"       --Info , {--isPart , --isaPart , --is-partition} [-ofs ofs]     "<<endl;
	...
	cout<<"           edges below the threshold. Example:                         "<<endl;
	cout<<"                 partanalyzer --cluster gf -below 0.7                  "<<endl;
	cout<<"                 partanalyzer --cluster gf   0.7                       "<<endl;
	cout<<"           both cases will first pruned the edges below 0.7 and the    "<<endl;
	...
	cout<<"          Specify the default format expected for the input paritions. "<<endl;
	cout<<"          Possible format values are: PART,MCL and FREE. See below.    "<<endl;
	cout<<"          As MCL is automatically recognized from the file content,    "<<endl;
	cout<<"          this option will be useful in two cases:                     "<<endl;
	cout<<"          (1) to distinguish between PART and FREE input partitions,   "<<endl;
	cout<<"          (2) in combination with --tab, if the output (specified with "<<endl;
	cout<<"              --oformat or the different format conversion options) is "<<endl;
	cout<<"              different from the (input) format specified with -t, the "<<endl;
	cout<<"              tabfile will be used for translating the labels of the   "<<endl;
	cout<<"              elements; however, if the _specified_ input and output   "<<endl;
	cout<<"              formats coindice, the original labels will be preserved. "<<endl;
	cout<<"              Example: p.mcl is in MCL format; p.lst, in PART format.  "<<endl;
	cout<<"                  partanalyzer -t PART --tab tbf -V p.mcl p.lst        "<<endl;
	cout<<"              this gives the distance between the two by using the tab "<<endl;
	cout<<"              file on p.mcl, but NOT on p.lst.                         "<<endl;
	cout<<"          Default input format is PART.                                "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --oformat [pfmt=input_partition_file_format]                    "<<endl;
	cout<<"          Specify the ouput format when printing partitions.           "<<endl;
	cout<<"          Default output format is PART.                               "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"File formats:                                                          "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       matrix-of-values (an undirected graph):                         "<<endl;
