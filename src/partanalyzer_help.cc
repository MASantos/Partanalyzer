...
void printHelpLong(){
	...
	cout<<"                                                                       "<<endl;
	cout<<"       -n , --ipot  entropy [(-e|-ext) extensivity]                    "<<endl;
	...
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --mpot, --mutual-potential entropy [-ext extensivity]           "<<endl;
	...
	cout<<"       --SSA, --strong-subadditivity entropy [-ext extensivity]        "<<endl;
	...
	cout<<"          as for option --ipot.                                        "<<endl;
	cout<<"                                                                       "<<endl;
	cout<<"       --SSSA, --soft-strong-subadditivity entropy [-ext extensivity]  "<<endl;
