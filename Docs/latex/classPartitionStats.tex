...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Sampling} Partition\-Stats::distances\-Distribution (pmetricv {\em pm} = shannon, int {\em refindex} = -1)}\label{classPartitionStats_a44}
...
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Partition Partition\-Stats::get\-Consensus\-Partition ()}\label{classPartitionStats_a15}
